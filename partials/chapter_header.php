			...
			<div class="row blog-detail-title-line col-xs-12">
				...
				<div class="blog-entry-title-line-buttons col-xs-12 col-sm-4 col-md-4" >
						...
						<div class="col-xs-6 col-sm-6">
							<?php if(get_field('pdf_version',get_option('page_on_front'))) : ?>
								<a href="<?php the_field('pdf_version',get_option('page_on_front'))?>" class="more_info">
									<button class="btn-openaccess">PDF</button>
								</a>
							<?php endif; ?>
						</div>
						<div class="col-xs-6 col-sm-6">
							<?php if(get_field('epub_version',get_option('page_on_front'))) : ?>
							<a href="<?php the_field('epub_version',get_option('page_on_front'))?>" class="more_info">
